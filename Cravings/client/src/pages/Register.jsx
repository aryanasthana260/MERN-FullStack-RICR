            ...
            >
              ...
              <div className="flex gap-4 pt-8 border-t-2 border-gray-200 ">
                <button
                  type="reset"
                  disabled={isLoading}
                  className="flex-1 bg-gray-300 text-gray-800 font-bold py-4 px-6 rounded-lg hover:bg-gray-400 transition duration-300 transform hover:scale-105 disabled:hover:scale-100 disabled:bg-gray-300 disabled:cursor-not-allowed"
                >
                  Clear Form
                </button>

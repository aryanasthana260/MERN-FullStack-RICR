            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleSubmit}
                  disabled
                  className="cursor-not-allowed w-full mt-1 px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
                />
              </div>
              ...
              <div className="flex gap-4 pt-6 border-t">
                ...
                <button
                  type="button"
                  disabled={loading}
                  className="flex-1 bg-linear-to-r from-indigo-600 to-indigo-700 text-white font-semibold py-3 rounded-lg hover:from-indigo-700 hover:to-indigo-800 transition shadow-lg"
                >
                  Save Changes
                </button>
              </div>
